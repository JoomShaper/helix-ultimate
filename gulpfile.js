...
const config = {
    ...
    qsPackageName: 'helix_ultimate_quickstart_j4_2.0.7.zip',
    packageName: 'helix_ultimate_pkg_2.0.7.zip',
    pluginPackageName: 'helix_ultimate_plugin_pkg_2.0.7.zip',
    templatePackageName: 'helix_ultimate_template_pkg_2.0.7.zip',
