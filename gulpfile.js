...
const config = {
    ...
    qsPackageName: 'helixultimate_quickstart_j5_2.2.10.zip',
    packageName: 'helixultimate_template_v2.2.10.zip',
    pluginPackageName: 'plg_system_helixultimate_v2.2.10.zip',
