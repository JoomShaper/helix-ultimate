 ...
 */
	...
	$isAuthorizedPreview = ($app->input->get('helixMode', '') === 'edit') && $user && ($user->authorise('core.edit', 'com_templates') || $user->authorise('core.admin'));

	// Coming Soon
	if (!$isAuthorizedPreview)
	{
		if (!\is_null($this->params->get('comingsoon', null)) && (!$user || !$user->authorise('core.admin')))
		{
