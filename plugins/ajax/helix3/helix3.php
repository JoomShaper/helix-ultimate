...
require_once JPATH_PLUGINS . '/system/helix3/layout/layout-settings/helix4-helpers.php';
...
class plgAjaxHelix3 extends JPlugin
{
    ...
    function onAjaxHelix3()
    {
        ...
        if( $action == 'save-tmpl-style' ){
            $report['action'] = 'save-tmpl-style';
            $report['status'] = 'true';
                ...
                case 'header_logo_block_load':
                    ...
                    switch ($selected_module){
                        case 'header_logo':
                            $data = array(
                                'success'   => true,
                                'data'   => '<img src="http://10.0.1.28/joomla/helix3/images/joomla_black.gif">',
                            );
                            die(json_encode($data));
                            break;
                        case 'header_menu_links':
                            $menu_ul = '<ul>
                                <li><a href="#">Home</a> </li>
                            ...
                            die(json_encode($data));
                            break;
                        case 'footer_about_us_social':
                            $render = '<img src="http://10.0.1.28/joomla/helix3/images/joomla_green.gif">';
                            $render .= '<p>This is about us page comes from module</p>';
                            $render .= '<ul class="footer_social_ul"><li><a href="#"><i class="fa fa-facebook"></i></a> </li><li><a 
href="#"><i class="fa fa-twitter"></i></a> 
</li><li><a href="#"><i class="fa fa-youtube"></i></a> </li><li><a href="#"><i class="fa fa-instagram"></i></a> </li><ul></ul></ul>';
...
href="#"><i class="fa fa-twitter"></i></a> 
                ...
                case 'footer_about_us_social_block_load':
                    $selected_module = $data['selected_module'];
...
href="#"><i class="fa fa-twitter"></i></a> 
                    ...
                    break;
                case 'footer_block_2_block_load':
                    $selected_module = $data['selected_module'];
...
href="#"><i class="fa fa-twitter"></i></a> 
                            ...
                            break;
                        case 'footer_block_2':
                            $render = '<h4>Home</h4><ul><li><a href="#">Home</a> </li><li><a href="#">About</a> </li><li><a href="#">Classes</a> </li><ul></ul></ul>';
                            ...
                            break;
                        case 'footer_block_3':
                            $render = '<h4>Features</h4><ul><li><a href="#">Refund Policy</a> </li><li><a href="#">Terms and condition</a> </li><li><a href="#">Frequently asked question</a> </li><ul></ul></ul>';
                    ...
                    break;
                case 'footer_block_3_block_load':
                    $selected_module = $data['selected_module'];
...
href="#"><i class="fa fa-twitter"></i></a> 
                ...
                case 'footer_block_4_block_load':
                    $selected_module = $data['selected_module'];
                    switch ($selected_module){
                        case 'header_logo':
                            $data = array(
...
href="#"><i class="fa fa-twitter"></i></a> 
                        ...
                        case 'footer_block_3':
                            ...
                            break;
                        case 'footer_block_4':
                            $render = '<h4>Our Partners</h4><ul><li><a href="#">Refund Policy</a> </li><li><a href="#">Terms and condition</a> </li><li><a href="#">Frequently asked question</a> </li><ul></ul></ul>';
...
href="#"><i class="fa fa-twitter"></i></a> 
                ...
                case 'helixfw_save_option':
                    $selected_header = $data['selected_header'];
                ...
                case  'helixfw_switch_header':
                    ...
                    $selected_header = $data['selected_header'];
                    $header = $path.$selected_header.'.php';
                    ...
                    if (file_exists($header)){
                        ...
                        $ajaxTplLayoutData = json_decode($tplParams->get('layout'));
                ...
                case  'helixfw_switch_footer':
                    ...
                    $selected_header = $data['selected_footer'];
                    $header = $path.$selected_header.'.php';

                    if (file_exists($header)){
                        //Update Current Header
                        helixfw_update_option('selected_footer', $selected_header);
