    ...
    <div class="helix-ultimate-col-sm-9">
        <div class="helix-ultimate-megamenu-wrap">
            <div class="helix-ultimate-megamenu-actions">
                ...
                <div>
                    <span class="helix-ultimate-megamenu-label">Badge</span>
                    <input type="text" id="helix-ultimate-menu-badge" placeholder="Badge Text" value="<?php echo $badge; ?>" />
                </div>

                <div>
                    <span class="helix-ultimate-megamenu-label">Badge Position</span>
                    <select id="helix-ultimate-badge-position">
                        <option value="left" <?php echo ($badge_position == 'left') ? 'selected' : ''; ?>><?php echo JText::_('HELIX_ULTIMATE_GLOBAL_LEFT'); ?></option>
                        <option value="right" <?php echo ($badge_position == 'right') ? 'selected' : ''; ?>><?php echo JText::_('HELIX_ULTIMATE_GLOBAL_RIGHT'); ?></option>
                    </select>
                </div>

                <div>
                    <span class="helix-ultimate-megamenu-label">Background Color</span>
                    <input type="text" class="minicolors" id="helix-ultimate-menu-badge-bg-color" placeholder="#333333" value="<?php echo $badge_bg_color; ?>" />
                </div>

                <div>
                    <span class="helix-ultimate-megamenu-label">Text Color</span>
                    <input type="text" class="minicolors" id="helix-ultimate-menu-badge-text-color" placeholder="#ffffff" value="<?php echo $badge_text_color; ?>" />
                </div>
            </div>
