        ...
        <div class="mod-login__username form-group mb-3">
            <?php if (!$params->get('usetext', 0)) : ?>
                <div class="input-group">
                    <input id="modlgn-username-<?php echo $module->id; ?>"
                           type="text"
                           name="username"
                           class="form-control"
                           autocomplete="username"
                           placeholder="<?php echo Text::_('MOD_LOGIN_VALUE_USERNAME'); ?>">
                    <label for="modlgn-username-<?php echo $module->id; ?>" class="visually-hidden">
        ...
        <div class="mod-login__password form-group mb-3">
            <?php if (!$params->get('usetext', 0)) : ?>
                <div class="input-group">
                    ...
                    <label for="modlgn-passwd-<?php echo $module->id; ?>" class="visually-hidden">
