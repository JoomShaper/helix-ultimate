...
<?php if ($og): ?>
    ...
    ?>
	<?php echo LayoutHelper::render('joomla.content.open_graph', ['image' => $full_image, 'title' => $displayData->title, 'fb_app_id' => $tplParams->get('og_fb_id'), 'twitter_site' => $tplParams->get('og_twitter_site'), 'content' => $displayData->introtext]); ?>
<?php endif; ?>
