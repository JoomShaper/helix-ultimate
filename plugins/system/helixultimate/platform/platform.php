...
class Platform
{
    ...
    private function frameworkFormHTMLEnd()
    {
        ...
        $htmlView .= '<div class="helix-ultimate-copyright">Helix Ultimate Framework '. $this->version .' RC2<br />By <a target="_blank" href="https://www.joomshaper.com">JoomShaper</a></div>';
