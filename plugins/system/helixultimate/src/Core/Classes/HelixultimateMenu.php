...
class HelixultimateMenu
{
	...
	private function item($item, $extra_class='')
	{
		...
		if (isset($layout->badge) && $layout->badge)
		{
			...
			$badgeBgColor = Helper::sanitizeMegaMenuColor(isset($layout->badge_bg_color) ? $layout->badge_bg_color : '');
			$badgeTextColor = Helper::sanitizeMegaMenuColor(isset($layout->badge_text_color) ? $layout->badge_text_color : '');
