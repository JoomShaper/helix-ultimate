...
class JFormFieldHelixDevices extends FormField
{
	...
	protected function getInput()
	{
		...
		$output .= '		<button class="device-btn ' . ($value === 'sm' ? 'active' : '') . '" data-device="sm" title="Mobile">';
		$output .= '			<svg width="12" height="12" viewBox="0 0 11 19" fill="none" xmlns="http://www.w3.org/2000/svg">';
		...
		$output .= '			</svg>';
		$output .= '		</button>';
		$output .= '		<button class="device-btn ' . ($value === 'md' ? 'active' : '') . '" data-device="md" title="Tablet">';
		$output .= '			<svg width="12" height="12" viewBox="0 0 16 19" fill="none" xmlns="http://www.w3.org/2000/svg">';
		...
		$output .= '			</svg>';
		$output .= '		</button>';
		$output .= '		<button class="device-btn ' . ($value === 'lg' ? 'active' : '') . '" data-device="lg" title="Desktop">';
		$output .= '			<svg width="12" height="12" viewBox="0 0 22 19" fill="none" xmlns="http://www.w3.org/2000/svg">';
		...
		$output .= '<input type="hidden" name="' . $this->name . '" id="' . $this->id . '" value="' . $value . '" />';
