			...
			if ($image['error'] === UPLOAD_ERR_OK)
			{
				...
				if (!$error)
				{
					...
					if (File::upload($path, $dest))
					{
						...
						if ($gallery)
						{
							$report['output'] = '<a href="#" class="btn btn-mini btn-danger btn-helix-ultimate-remove-gallery-image"><span class="fa fa-times"></span></a><img src="' . URI::root(true) . '/' . $src . '" alt="">';
