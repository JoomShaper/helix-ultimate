...
class HelixUltimateFeatureMenu
{
	...
	public function renderFeature()
	{
		...
		if ($menu_type === 'mega_offcanvas')
		{
			...
			{
				$output .= '<a id="offcanvas-toggler" aria-label="' . Text::_('HELIX_ULTIMATE_NAVIGATION') . '" class="offcanvas-toggler-right" href="#"><div class="burger-icon" aria-hidden="true"><span></span><span></span><span></span></div><span class="visually-hidden">' . Text::_('HELIX_ULTIMATE_OFFCANVAS_TOGGLE_HIDEN') . '</span></a>';
			}
			$output .= '</nav>';
		}
		elseif ($menu_type === 'mega')
		{
			...
			if ($offcanvas_position === 'right')
			{
				$output .= '<a id="offcanvas-toggler" aria-label="' . Text::_('HELIX_ULTIMATE_NAVIGATION') . '" class="offcanvas-toggler-right d-flex d-lg-none" href="#"><div class="burger-icon" aria-hidden="true"><span></span><span></span><span></span></div><span class="visually-hidden">' . Text::_('HELIX_ULTIMATE_OFFCANVAS_TOGGLE_HIDEN') .'</span></a>';
			}
