...
<div class="article-details<?php echo $this->pageclass_sfx; ?>" itemscope itemtype="https://schema.org/Article">
	...
	<div class="article-author-information card mb-5">
		<div class="card-body">
			<?php 
				$author = \JFactory::getUser( (int) $this->item->created_by );
				$profile = \JUserHelper::getProfile( (int) $this->item->created_by );
			?>
			<div class="media">
					...
					<?php if(isset($profile->profile['aboutme']) && $profile->profile['aboutme']) : ?>
						<div class="author-bio">
							...
							<?php if(isset($profile->profile['website']) && $profile->profile['website']) : ?>
								<div class="author-website mt-1">
									<a target="_blank" href="<?php echo strip_tags($profile->profile['website'], ''); ?>"><span class="fa fa-globe"></span></a>
								</div>
							<?php endif; ?>
						</div>
					<?php endif; ?>
