...
$hasModMenu = array_search(
    'mod_menu',
    array_column(ModuleHelper::getModules('offcanvas'), 'module')
);
...
$menuModule = Helper::createModule('mod_menu', [
    'title'  => 'Main Menu',
    'params' => '{"menutype":"' . $menuType . '","base":"","startLevel":1,"endLevel":'
        . $maxLevel
        . ',"showAllChildren":1,"tag_id":"","class_sfx":" nav-pills","window_open":"","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"itemid","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0", "hu_offcanvas": 1}',
    'name'   => 'menu'
]);
...
<!-- NOTE: class changed from `left-1` to `right-1` -->
<div class="offcanvas-menu right-1" tabindex="-1" inert>
    <div class="d-flex align-items-center p-3 pt-4 justify-content-between">
        <?php 
